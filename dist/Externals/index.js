...
var ExternalsGenerator = (function () {
    function ExternalsGenerator(models) {
        ...
        this.connect = function () {
            return common_tags_1.codeBlock(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      @send\n      external connect: (prismaClient) => Js.Promise2.t<unit> = \"connect\";\n    "], ["\n      @send\n      external connect: (prismaClient) => Js.Promise2.t<unit> = \"connect\";\n    "])));
        };
        this.disconnect = function () {
            return common_tags_1.codeBlock(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      @send\n      external disconnect: (prismaClient) => Js.Promise2.t<unit> = \"disconnect\";\n    "], ["\n      @send\n      external disconnect: (prismaClient) => Js.Promise2.t<unit> = \"disconnect\";\n    "])));
        };
        this.findOne = function (model) {
            var hasRelations = model.fields.some(function (field) { return field.kind === 'object'; });
            return common_tags_1.codeBlock(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      module FindOne: {\n        type t = {\n          select: option<", ".Select.t>,\n          ", "\n          where: ", ".WhereUniqueInput.t\n        };\n\n        @send @scope(\"", "\")\n        external make: (prismaClient, t) =>\n          Js.Promise2.t<", ".t> = \"findOne\";\n      };\n    "], ["\n      module FindOne: {\n        type t = {\n          select: option<", ".Select.t>,\n          ", "\n          where: ", ".WhereUniqueInput.t\n        };\n\n        @send @scope(\"", "\")\n        external make: (prismaClient, t) =>\n          Js.Promise2.t<", ".t> = \"findOne\";\n      };\n    "])), model.name, hasRelations ? "include_: option<" + model.name + ".Include.t>," : '', model.name, model.name.toLowerCase(), model.name);
        };
        this.findMany = function (model) {
            var hasRelations = model.fields.some(function (field) { return field.kind === 'object'; });
            return common_tags_1.codeBlock(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      module FindMany: {\n        type t = {\n          select: option<", ".Select.t>,\n          ", "\n          where: option<", ".WhereInput.t>,\n          skip: option<int>,\n          after: option<", ".WhereUniqueInput.t>,\n          before: option<", ".WhereUniqueInput.t>,\n          first: option<int>,\n          last: option<int>,\n        };\n\n        @send @scope(\"", "\")\n        external make: (prismaClient, t) =>\n          Js.Promise2.t<array<", ".t>> = \"findMany\";\n      };\n    "], ["\n      module FindMany: {\n        type t = {\n          select: option<", ".Select.t>,\n          ", "\n          where: option<", ".WhereInput.t>,\n          skip: option<int>,\n          after: option<", ".WhereUniqueInput.t>,\n          before: option<", ".WhereUniqueInput.t>,\n          first: option<int>,\n          last: option<int>,\n        };\n\n        @send @scope(\"", "\")\n        external make: (prismaClient, t) =>\n          Js.Promise2.t<array<", ".t>> = \"findMany\";\n      };\n    "])), model.name, hasRelations ? "include_: option<" + model.name + ".Include.t>," : '', model.name, model.name, model.name, model.name.toLowerCase(), model.name);
        };
        this.create = function (model) {
            var hasRelations = model.fields.some(function (field) { return field.kind === 'object'; });
            return common_tags_1.codeBlock(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      module Create: {\n        type t = {\n          select: option<", ".Select.t>,\n          ", "\n          data: ", ".CreateInput.t\n        };\n\n        @send @scope(\"", "\")\n        external make: (prismaClient, t) =>\n          Js.Promise2.t<", ".t> = \"create\";\n      };\n    "], ["\n      module Create: {\n        type t = {\n          select: option<", ".Select.t>,\n          ", "\n          data: ", ".CreateInput.t\n        };\n\n        @send @scope(\"", "\")\n        external make: (prismaClient, t) =>\n          Js.Promise2.t<", ".t> = \"create\";\n      };\n    "])), model.name, hasRelations ? "include_: option<" + model.name + ".Include.t>," : '', model.name, model.name.toLowerCase(), model.name);
        };
        this.update = function (model) {
            return common_tags_1.codeBlock(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      \n    "], ["\n      \n    "])));
        };
        this.updateMany = function (model) {
            return common_tags_1.codeBlock(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      \n    "], ["\n      \n    "])));
        };
        this.upsert = function (model) {
            return common_tags_1.codeBlock(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n      \n    "], ["\n      \n    "])));
        };
